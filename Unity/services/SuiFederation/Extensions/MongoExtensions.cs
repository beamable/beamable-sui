...
public static class MongoExtensions
{
    public static void SetupMongoExtensions(this IServiceInitializer _)
    {
        ...
        BsonClassMap.RegisterClassMap<NftContract>(cm => cm.AutoMap());
        BsonClassMap.RegisterClassMap<CoinContract>(cm => cm.AutoMap());
        BsonClassMap.RegisterClassMap<GameCoinContract>(cm => cm.AutoMap());
        BsonClassMap.RegisterClassMap<KioskContract>(cm => cm.AutoMap());
        BsonClassMap.RegisterClassMap<PlayerKioskContract>(cm => cm.AutoMap());
        BsonClassMap.RegisterClassMap<PersonalKioskContract>(cm => cm.AutoMap());
        BsonClassMap.RegisterClassMap<RoyaltyKioskContract>(cm => cm.AutoMap());
    }
}
