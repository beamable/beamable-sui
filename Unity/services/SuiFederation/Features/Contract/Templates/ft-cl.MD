...
Smart contract for the Closed loop token lives [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/game_coin.move)  
...
### Mint
The entry point for the mint function is [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/game_coin.move#L81) It requires:
...
### Burn
The entry point for the burn function is [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/game_coin.move#L93) It requires:
- custom store object holding the treasury and profits
- token to burn

The burn operation [handles](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/SuiApi/ts/bridge.ts#L623) coin fragmentation and automatically splits/merges the required target amount. 