...
Smart contract for the composable NTFs lives [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/nft_addon.move)  
...
### Add
The entry point for the add function is [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/nft_addon.move#L119) It requires:
- parent NFT object
...
### Remove
The entry point for the remove function is [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/nft_addon.move#L139) It requires:
- parent NFT object
- content ID of the new NFT addon as the unique identifier of the parent dynamic field

### Update nested NFT attribute
The entry point for the update function is [here.](https://github.com/beamable/Sui-MonoRepo/blob/main/Unity/services/SuiFederation/Features/Contract/Templates/nft_addon.move#L157) It requires:
- NFT object
