...
public static class ServiceRegistration
{
    public static void AddEndpoints(this IDependencyBuilder builder)
    {
        ...
        builder.AddScoped<PersonalKioskCreateEndpoint>();
        builder.AddScoped<PersonalKioskDelistEndpoint>();
        builder.AddScoped<PersonalKioskListEndpoint>();
        builder.AddScoped<PersonalKioskTakeEndpoint>();
        builder.AddScoped<PersonalKioskDeclinePurchaseEndpoint>();
        builder.AddScoped<PersonalKioskCancelExclusiveEndpoint>();
        builder.AddScoped<PersonalKioskPurchaseEndpoint>();
        builder.AddScoped<PersonalKioskWithdrawEndpoint>();
    }
}