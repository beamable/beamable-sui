...
namespace Game.Scripts.UI
{
    public class UiDemoWeaponShower : MonoBehaviour
    {
        ...
        public void ShowWeaponCard(bool show)
        {
            if (show)
            {
                meleeWeaponCard.SetWeaponCard(BeamInventoryManager.Instance.GetOwnedMeleeWeapon(), null, false);
                rangedWeaponCard.SetWeaponCard(BeamInventoryManager.Instance.GetOwnedRangedWeapon(), null, false);
