...
namespace MoeBeam.Game.Scripts.Player
{
    public class PlayerHealth : MonoBehaviour
    {
        ...
        {
            //scale current health by creature biome level
            var creatureBiomeLevel = BeamContentManager.Instance.GetCurrentCreature().CurrentBiome.Level;
            maxHealth = (int)(maxHealth * (1 + creatureBiomeLevel * 0.1f));
