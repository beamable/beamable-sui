...
class UNREALSUISAMPLE_API USuiWalletSigner : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SUI")
	void GetSUIIdentityInfo(FString& MicroserviceId, FString& FederationId,
		FString& SuiExternalId, FString& SuiEnokiId, FString& OutWalletId)
	{
		MicroserviceId = TEXT("SuiFederation");
		FederationId = TEXT("SuiIdentity");
		SuiExternalId = TEXT("SuiExternalIdentity");
		SuiEnokiId = TEXT("SuiEnokiIdentity");
		OutWalletId = WalletId;
	}
	...
	UFUNCTION(BlueprintPure, Category = "Enoki")
	static void GetEnokiProviders(FString& Google, FString& Twitch)
	{
		Google = TEXT("google");
		Twitch = TEXT("twitch");
	}
