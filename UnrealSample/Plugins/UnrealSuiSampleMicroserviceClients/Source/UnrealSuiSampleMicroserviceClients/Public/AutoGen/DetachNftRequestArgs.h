...
#include "DetachNftRequestArgs.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class UNREALSUISAMPLEMICROSERVICECLIENTS_API UDetachNftRequestArgs : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
