...
#include "UnrealSuiSampleMicroserviceClients/Public/AutoGen/IncrementStatRequestArgs.h"
...
class UNREALSUISAMPLEMICROSERVICECLIENTS_API ULiveOpsDemoMSIncrementStatRequest : public UObject, public IBeamBaseRequestInterface
{
	GENERATED_BODY()
