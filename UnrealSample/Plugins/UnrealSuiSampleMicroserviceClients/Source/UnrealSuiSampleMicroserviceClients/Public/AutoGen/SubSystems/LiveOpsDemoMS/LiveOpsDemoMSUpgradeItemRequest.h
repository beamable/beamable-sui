...
#include "UnrealSuiSampleMicroserviceClients/Public/AutoGen/LiveOpsDemoMSUpgradeItemResponse.h"

#include "LiveOpsDemoMSUpgradeItemRequest.generated.h"

UCLASS(BlueprintType)
class UNREALSUISAMPLEMICROSERVICECLIENTS_API ULiveOpsDemoMSUpgradeItemRequest : public UObject, public IBeamBaseRequestInterface
{
	GENERATED_BODY()
...
public:
	...
	static ULiveOpsDemoMSUpgradeItemRequest* Make(FString _ContentId, int64 _ItemInstanceId, FString _NewLevel, UObject* RequestOwner, TMap<FString, FString> CustomHeaders);
};
