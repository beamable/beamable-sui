...
class UNREALSUISAMPLEMICROSERVICECLIENTS_API USuiFederationGetSuiEnvironmentRequest : public UObject, public IBeamBaseRequestInterface
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|SuiFederation|Utils|Make/Break", DisplayName="Make SuiFederationGetSuiEnvironment",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner", AutoCreateRefTerm="CustomHeaders"))
