...
#include "UnrealSuiSampleMicroserviceClients/Public/AutoGen/SubSystems/LiveOpsDemoMS/LiveOpsDemoMSUpgradeItemRequest.h"
...
#include "UnrealSuiSampleMicroserviceClients/Public/AutoGen/SubSystems/LiveOpsDemoMS/LiveOpsDemoMSIncrementStatRequest.h"
#include "UnrealSuiSampleMicroserviceClients/Public/AutoGen/SubSystems/LiveOpsDemoMS/LiveOpsDemoMSGetSampleStatRequest.h"
...
class UNREALSUISAMPLEMICROSERVICECLIENTS_API UBeamLiveOpsDemoMSApi : public UBeamMicroserviceClientSubsystem
{
private:
	GENERATED_BODY()
	 ...
	 * @brief Private implementation for requests that require authentication that all overloaded BP UFunctions call.	  
	 */
	void BP_AttachNftImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, ULiveOpsDemoMSAttachNftRequest* RequestData,
	                  const FOnLiveOpsDemoMSAttachNftSuccess& OnSuccess, const FOnLiveOpsDemoMSAttachNftError& OnError, const FOnLiveOpsDemoMSAttachNftComplete& OnComplete, 
					  int64& OutRequestId, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;
	/**
	 * @brief Overload version for binding lambdas when in C++ land. Prefer the BP version whenever possible, this is here mostly for quick experimentation purposes.	 
	 */
	void CPP_AttachNftImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, ULiveOpsDemoMSAttachNftRequest* RequestData,
	                   const FOnLiveOpsDemoMSAttachNftFullResponse& Handler, int64& OutRequestId, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;
		
	/**
	 * @brief Private implementation for requests that require authentication that all overloaded BP UFunctions call.	  
	 */
	void BP_DetachNftImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, ULiveOpsDemoMSDetachNftRequest* RequestData,
	                  const FOnLiveOpsDemoMSDetachNftSuccess& OnSuccess, const FOnLiveOpsDemoMSDetachNftError& OnError, const FOnLiveOpsDemoMSDetachNftComplete& OnComplete, 
					  int64& OutRequestId, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;
	/**
	 * @brief Overload version for binding lambdas when in C++ land. Prefer the BP version whenever possible, this is here mostly for quick experimentation purposes.	 
	 */
	void CPP_DetachNftImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, ULiveOpsDemoMSDetachNftRequest* RequestData,
	                   const FOnLiveOpsDemoMSDetachNftFullResponse& Handler, int64& OutRequestId, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;
...
public:
	...
	/**
	 * @brief Makes an authenticated request to the Post /AttachNft endpoint of the LiveOpsDemoMS Service.
	 *
	 * PREFER THE UFUNCTION OVERLOAD AS OPPOSED TO THIS. THIS MAINLY EXISTS TO ALLOW LAMBDA BINDING THE HANDLER.
	 * (Dynamic delegates do not allow for that so... we autogen this one to make experimenting in CPP a bit faster).
	 * 
	 ...
	 * @param CallingContext A UObject managed by the UWorld that's making the request. Used to support multiple PIEs (see UBeamUserSlot::GetNamespacedSlotId) and read-only RequestCaches. 
	 */
	void CPP_AttachNft(const FUserSlot& UserSlot, ULiveOpsDemoMSAttachNftRequest* Request, const FOnLiveOpsDemoMSAttachNftFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;

		
	/**
	 * @brief Makes an authenticated request to the Post /DetachNft endpoint of the LiveOpsDemoMS Service.
	 *
	 * PREFER THE UFUNCTION OVERLOAD AS OPPOSED TO THIS. THIS MAINLY EXISTS TO ALLOW LAMBDA BINDING THE HANDLER.
	 * (Dynamic delegates do not allow for that so... we autogen this one to make experimenting in CPP a bit faster).
	 * 
	 ...
	 * @param CallingContext A UObject managed by the UWorld that's making the request. Used to support multiple PIEs (see UBeamUserSlot::GetNamespacedSlotId) and read-only RequestCaches. 
	 */
	void CPP_DetachNft(const FUserSlot& UserSlot, ULiveOpsDemoMSDetachNftRequest* Request, const FOnLiveOpsDemoMSDetachNftFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintInternalUseOnly, Category="Beam|LiveOpsDemoMS|Utils|Make/Break", meta=(DefaultToSelf="CallingContext", AdvancedDisplay="OpHandle,CallingContext",AutoCreateRefTerm="UserSlot,OnSuccess,OnError,OnComplete,OpHandle", BeamFlowFunction))
	void AttachNft(FUserSlot UserSlot, ULiveOpsDemoMSAttachNftRequest* Request, const FOnLiveOpsDemoMSAttachNftSuccess& OnSuccess, const FOnLiveOpsDemoMSAttachNftError& OnError, const FOnLiveOpsDemoMSAttachNftComplete& OnComplete, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintInternalUseOnly, Category="Beam|LiveOpsDemoMS|Utils|Make/Break", meta=(DefaultToSelf="CallingContext", AdvancedDisplay="OpHandle,CallingContext",AutoCreateRefTerm="UserSlot,OnSuccess,OnError,OnComplete,OpHandle", BeamFlowFunction))
	void DetachNft(FUserSlot UserSlot, ULiveOpsDemoMSDetachNftRequest* Request, const FOnLiveOpsDemoMSDetachNftSuccess& OnSuccess, const FOnLiveOpsDemoMSDetachNftError& OnError, const FOnLiveOpsDemoMSDetachNftComplete& OnComplete, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr);
