...
#include "UnrealSuiSampleMicroserviceClients/Public/AutoGen/GetSampleStatRequestArgs.h"
...
class UNREALSUISAMPLEMICROSERVICECLIENTS_API ULiveOpsDemoMSGetSampleStatRequest : public UObject, public IBeamBaseRequestInterface
{
	GENERATED_BODY()
