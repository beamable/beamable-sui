...
ULiveOpsDemoMSUpgradeItemRequest* ULiveOpsDemoMSUpgradeItemRequest::Make(FString _ContentId, int64 _ItemInstanceId, FString _NewLevel, UObject* RequestOwner, TMap<FString, FString> CustomHeaders)
{
