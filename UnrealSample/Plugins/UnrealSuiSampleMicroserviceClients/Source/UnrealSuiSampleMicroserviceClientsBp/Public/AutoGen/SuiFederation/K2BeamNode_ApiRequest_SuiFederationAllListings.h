...
#include "K2BeamNode_ApiRequest_SuiFederationAllListings.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationAllListings"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /AllListings  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationAllListings : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
