...
#include "K2BeamNode_ApiRequest_SuiFederationKioskPurchase.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationKioskPurchase"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /KioskPurchase  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationKioskPurchase : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
