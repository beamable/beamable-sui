...
#include "K2BeamNode_ApiRequest_SuiFederationGenerateRealmAccount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationGenerateRealmAccount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GenerateRealmAccount  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationGenerateRealmAccount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
