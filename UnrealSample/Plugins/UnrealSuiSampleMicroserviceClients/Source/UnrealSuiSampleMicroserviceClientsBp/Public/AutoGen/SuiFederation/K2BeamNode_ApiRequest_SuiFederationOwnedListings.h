...
#include "K2BeamNode_ApiRequest_SuiFederationOwnedListings.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationOwnedListings"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /OwnedListings  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationOwnedListings : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
