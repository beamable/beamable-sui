...
#include "K2BeamNode_ApiRequest_SuiFederationInitializeContentContracts.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationInitializeContentContracts"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /InitializeContentContracts  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationInitializeContentContracts : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
