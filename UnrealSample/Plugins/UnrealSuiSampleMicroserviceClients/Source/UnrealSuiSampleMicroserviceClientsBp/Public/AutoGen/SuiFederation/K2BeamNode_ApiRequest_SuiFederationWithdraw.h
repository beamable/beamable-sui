...
#include "K2BeamNode_ApiRequest_SuiFederationWithdraw.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationWithdraw"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /Withdraw  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationWithdraw : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
