...
#include "K2BeamNode_ApiRequest_SuiFederationListForSale.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationListForSale"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /ListForSale  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationListForSale : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
