...
#include "K2BeamNode_ApiRequest_SuiFederationGetAccount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationGetAccount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetAccount  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationGetAccount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
