...
#include "K2BeamNode_ApiRequest_SuiFederationDelistFromSale.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationDelistFromSale"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /DelistFromSale  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationDelistFromSale : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
