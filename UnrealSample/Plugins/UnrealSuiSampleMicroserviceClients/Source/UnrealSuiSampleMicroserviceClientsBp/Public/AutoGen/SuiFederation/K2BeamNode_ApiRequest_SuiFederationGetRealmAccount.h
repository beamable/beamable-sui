...
#include "K2BeamNode_ApiRequest_SuiFederationGetRealmAccount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationGetRealmAccount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetRealmAccount  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationGetRealmAccount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
