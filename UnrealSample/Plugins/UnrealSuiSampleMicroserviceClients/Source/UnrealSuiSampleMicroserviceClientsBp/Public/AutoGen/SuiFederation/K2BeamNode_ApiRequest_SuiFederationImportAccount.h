...
#include "K2BeamNode_ApiRequest_SuiFederationImportAccount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationImportAccount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /ImportAccount  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationImportAccount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
