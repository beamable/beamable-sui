...
#include "K2BeamNode_ApiRequest_SuiFederationGetFederationInfo.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationGetFederationInfo"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetFederationInfo  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationGetFederationInfo : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
