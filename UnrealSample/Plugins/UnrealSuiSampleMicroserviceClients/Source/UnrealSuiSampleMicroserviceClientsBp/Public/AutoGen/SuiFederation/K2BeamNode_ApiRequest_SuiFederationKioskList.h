...
#include "K2BeamNode_ApiRequest_SuiFederationKioskList.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationKioskList"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /KioskList  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationKioskList : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
