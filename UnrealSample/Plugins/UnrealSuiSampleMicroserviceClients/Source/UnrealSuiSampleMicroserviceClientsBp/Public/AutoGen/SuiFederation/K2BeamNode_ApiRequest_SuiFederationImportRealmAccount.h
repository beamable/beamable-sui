...
#include "K2BeamNode_ApiRequest_SuiFederationImportRealmAccount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationImportRealmAccount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /ImportRealmAccount  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationImportRealmAccount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
