...
#include "K2BeamNode_ApiRequest_LiveOpsDemoMSDetachNft.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_LiveOpsDemoMSDetachNft"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /DetachNft  of the LiveOpsDemoMS Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_LiveOpsDemoMSDetachNft : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
