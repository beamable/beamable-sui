...
#include "K2BeamNode_ApiRequest_LiveOpsDemoMSAttachNft.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_LiveOpsDemoMSAttachNft"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /AttachNft  of the LiveOpsDemoMS Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREALSUISAMPLEMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_LiveOpsDemoMSAttachNft : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
